    ...
    >
      <div className="flex flex-col items-center justify-center gap-8 text-center">
        ...
        <div className="p-8 text-left w-full flex items-center justify-center">
            <form action="https://getform.io/f/a458405c-f648-412a-a374-6eb676e2809e" 
            method="POST">
                <div className="gap-4 w-full">
                    ...
                    <div className="flex flex-col">
                        ...
                        <textarea  rows="10" name="Message" className="border-2 rounded-lg p-3 flex focus:outline-none border-gray-400 dark:bg-gray-900 dark:text-white resize-none"></textarea>
                    </div>
                </div>
